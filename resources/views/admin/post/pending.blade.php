    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <h2 style="background-color: greenyellow;">All Pending Posts 
                    <span class="glyphicon glyphicon-bell">{{ $posts->count() }}</span></h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-dafault">
                                    <a title="Edit" href="{{ route('admin.post.edit',$post->id)}}" style="text-decoration: none;"> 
