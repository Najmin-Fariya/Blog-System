    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2><a class="btn btn-primary" href="{{ route('author.post.create')}}"><i class="fa fa-plus">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-dafault">
                                    <a title="View posts details" href="{{ route('author.post.show',$post->id)}}" style="text-decoration: none; color: #2795e9;"> 
                                        <i class="fa fa-eye"></i> </a>
                                </button>
                                <button class="btn btn-dafault">
                                    <a title="Edit your post" href="{{ route('author.post.edit',$post->id)}}" style="text-decoration: none;"> 
